...
public interface MessageProcessingModel {
   ...
   * @param securityModel
   *    the security model ID (see {@link SecurityModel}) to use.
   * @param securityName
   *    the principal on behalf the message is to be sent.
   * @param securityLevel
   *    the level of security requested (see {@link SecurityLevel}).
   * @param pdu
   ...
   * @param securityModel
   *    returns the security model ID (see {@link SecurityModel}.
   * @param securityName
   *    returns the principal.
   * @param securityLevel
   *    returns the requested security level (see {@link SecurityLevel}).
   * @param pdu

...
public class SyslogDefs {
	...
	//added by colin doug 2009-03-26
	public static final int LOG_AUTHPRIV = 10; /*security/authorization messages (note 1)*/
	public static final int LOG_FTP = 11;//  FTP daemon
	public static final int LOG_NTP = 12;// NTP subsystem
	public static final int LOG_AUDIT = 13;//log audit (note 1)
	//	public static final int LOG_ALERT = 14;// log alert (note 1)
	//	public static final int   15             clock daemon (note 2)
	...
	static {
		...
		facHash.put("AUTHPRIV", new Integer(SyslogDefs.LOG_AUTHPRIV));
		facHash.put("FTP", new Integer(SyslogDefs.LOG_FTP));
		facHash.put("NTP", new Integer(SyslogDefs.LOG_NTP));
		facHash.put("AUDIT", new Integer(SyslogDefs.LOG_AUDIT));
	...
	static public String getFacilityName(int facility) {
		...
		case SyslogDefs.LOG_CRON:
			return "cron";
			//added by Colin
		case SyslogDefs.LOG_AUTHPRIV:
			return "authpriv";
		case SyslogDefs.LOG_FTP:
			return "ftp";
		case SyslogDefs.LOG_NTP:
			return "ntp";
		case SyslogDefs.LOG_AUDIT:
			return "audit";
